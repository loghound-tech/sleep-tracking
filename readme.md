...
## Data Export
The easiest way to get your sleep data out of Apple Health in CSV format is to use the [**"Health Auto Export"** app for iOS](https://apps.apple.com/us/app/health-auto-export-json-csv/id1115567069). I've got no relation to this app, it's just an easy way to create a CSV and send it to your mac via aidrop.
...
- **Positive Correlation**: e.g., `+0.2` for Wake Time.
  ...
  ![Correlation Matrix](corr-matrix.png)
...
### Visualizations
1.  **Daily Sleep Analysis**: A stacked bar chart sleep_analysis_plot.html showing Core, Deep, REM, and Awake durations.
2.  **correlation matrix** -- this html file allows you to see what affects what -- The only thing you can really control is bed time so focus on that.
